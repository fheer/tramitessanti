<script type="text/javascript">
  ...
  {
      var url = '<?php echo base_url() . "funcionario/cambiarEstado/" ;?>';
  ...
  <div class="content-wrapper">
    <div class="page-header">
      <div class="pull-right">
        <a href="<?php echo base_url(); ?>funcionario/nuevo/1" class="btn btn-success"><span class="fa fa-plus-circle" aria-hidden="true"></span> Nuevo Funcionario</a>
        <a href="<?php echo base_url();?>imprimir/datosfuncionario" target="_blank" class="btn btn-info">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Lista Funcionarios</li>
        </ol>
      </nav>
    </div>
              ...
              <table id="order-listing" class="table">
                ...
                <tbody>
                  <?php $i = 1;
                    ...
                    $funcionario = $ciInstance->Cargo_model->getCargo($idcargo);
                  ?>
                    <tr>
                        ...
                        <span class="pull-right">
                          ...
                          <ul class="dropdown-menu pull-right" aria-labelledby="dropdownMenu1">
                           <li>
                            ...
                            if ($row['estado']==1) {
                              ?>
                               <a href="<?php echo base_url().'funcionario/aggiornare/'.$row['key']; ?>/2"
                          ...
                          <li>
                            ...
                            if ($row['estado']==1) {
                              ?>
                               <a href="#"
                               title="Estado Persona" onClick="return confirm_modal(<?php echo $row['idpersona']; ?>,0)">
                              ...
                              ?>
                              <a href="#"
                               title="Estado Persona" onClick="return confirm_modal(<?php echo $row['idpersona']; ?>,1)">
