    ...
    <div class="page-header">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Modificar Solicitante</li>
        </ol>
      </nav>
    </div>
    <div class="row grid-margin">
      <div class="col-12">
        <?php
          ...
          <?php } ?>
        <?php echo form_open(base_url().'solicitante/editarDB',array("class"=>"forms-sample","enctype"=>"multipart/form-data")); ?>
        <div class="form-group row">
          ...
          <div class="col-sm-1">
            <select class="js-example-basic-single w-100" name="idexpedido">
              <option value="<?php echo $solicitante['idexpedido']; ?>"><?php echo $solicitante['idexpedido']; ?></option>
        ...
        <?php }else{  
          ?>
          <a href="<?php echo base_url().'ventas/insert'; ?>" class="btn btn-light">Cancelar</a>
          <?php  
        } ?>
