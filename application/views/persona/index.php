  ...
  <div class="content-wrapper">
    <div class="page-header">
      <div class="pull-right">
        <a href="<?php echo base_url(); ?>solicitante/nuevo/1" class="btn btn-success"><span class="fa fa-plus-circle" aria-hidden="true"></span> Nuevo Solicitante</a>
        <a href="<?php echo base_url();?>imprimir/solicitantes" target="_blank" class="btn btn-info">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Lista Solicitantes</li>
        </ol>
      </nav>
    </div>
          ...
          <div class="col-12">
            <div class="table-responsive">
              <table id="order-listing" class="table">
                ...
                <tbody>
                  <?php $i = 1; foreach ($persona  as $row) { ?>
                    <tr>
                        ...
                        <span class="pull-right">
                          ...
                          <ul class="dropdown-menu pull-right" aria-labelledby="dropdownMenu1">
                           <li>
                            ...
                            if ($row['estado']==1) {
                              ?>
                               <a href="<?php echo base_url().'solicitante/aggiornare/'.$row['key']; ?>/1"
