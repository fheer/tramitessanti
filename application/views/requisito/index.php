<script type="text/javascript">
  ...
  {
    var url = '<?php echo base_url() . "requisito/eliminar/" ;?>';
  ...
  <div class="content-wrapper">
    <div class="page-header">
      <div class="pull-right">
        <a href="<?php echo base_url(); ?>requisito/nuevo" class="btn btn-success"><span class="fa fa-plus-circle" aria-hidden="true"></span> Nuevo Requisito</a>
        <a href="<?php echo base_url();?>imprimir/requisito" target="_blank" class="btn btn-info">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Lista Requisitos</li>
        </ol>
      </nav>
    </div>
          ...
          <div class="col-12">
            <div class="table-responsive">
              <table id="order-listing" class="table">
                ...
                <tbody>
                  <?php $i = 1; foreach ($requisito  as $row) { ?>
                    <tr>
                        ...
                        <span class="pull-right">
                          ...
                          <li>
                            ...
                            if ($row['estado']==1) {
                              ?>
                               <a href="#"
                               title="Estado Requisito" onClick="return confirm_modal(<?php echo $row['idrequisito']; ?>,0)">
                              ...
                              ?>
                              <a href="#"
                               title="Estado Requisito" onClick="return confirm_modal(<?php echo $row['idrequisito']; ?>,1)">
