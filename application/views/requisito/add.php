    ...
    <div class="row grid-margin">
      <div class="col-12">
        <?php
          ...
          <?php } ?>
        <?php echo form_open(base_url().'requisito/guardar',array("class"=>"forms-sample","enctype"=>"multipart/form-data")); ?>
        <div class="form-group row">
          <label for="nombreRequisito" class="col-sm-2 col-form-label">Nombre Requisito</label>
          <div class="col-sm-7">
            <input type="text" class="form-control" name="nombreRequisito" value="<?php echo $this->input->post('nombreRequisito'); ?>">
