                        ...
                        <span class="pull-right">
                          ...
                          <ul class="dropdown-menu pull-right" aria-labelledby="dropdownMenu1">
                           <li>
                            ...
                            if ($row['estado']==1) {
                              ?>
                               <a href="<?php echo base_url().'usuario/aggiornare/'.$row['slug']; ?>"
                          ...
                          <li>
                            ...
                            if ($row['estado']==1) {
                              ?>
                               <a href="#"
                               title="Estado Usuario" onClick="return confirm_modal(<?php echo $row['idusuario']; ?>,0)">
                              ...
                              ?>
                              <a href="#"
                               title="Estado Usuario" onClick="return confirm_modal(<?php echo $row['idusuario']; ?>,1)">
